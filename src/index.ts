...
import { httpServer, checkSchedule, checkClockFontSize, checkMessageFontSize } from './server';
...
let checkFontSizeInterval:any = undefined;
...
function initApp() {
  ...
  if(checkFontSizeInterval === undefined){
    checkFontSizeInterval = setInterval(checkFontSizeInInterval, 10000);
  }
  createWindow();
}

function checkFontSizeInInterval(){
